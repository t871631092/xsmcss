    ...
    <div class="row h-100p">
      <div class="col-md-4 p-25">
        ...
        >
          ...
          <el-table-column sortable label="课程类别">
            <template slot-scope="scope">{{
      ...
      <div class="col-md-8">
        ...
        <el-form class="p-25" ref="form" :model="form" label-width="80px">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.Post("admin/course", self.form, function (data) {
        if (data.success) {
          ...
          self.tableData = JSON.parse(JSON.stringify(data.data));
    ...
    getTeacher() {
      let self = this;
      this.Get("admin/teacher", { page: 0, size: 10000000 }, function (data) {
        if (data.success) {
